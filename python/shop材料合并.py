...
import pandas as pd
import numpy as ny
chuqin=pd.read_csv(r"D:\Chrome下载\sqlresult_4357467.csv")
chuqin["mark"]=chuqin["员工工号"].astype(str)+chuqin["统计日期"]
lanjian=pd.read_csv(r"D:\Chrome下载\sqlresult_4356902.csv")
...
hebing1.to_excel(excel_writer=r"D:\Onedrive\2，每日导数\梦雨导数\28121.xlsx")
###########################################